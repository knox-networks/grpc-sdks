...
@kotlin.jvm.JvmName("-initializecreateStatusListEntryRequest")
public inline fun createStatusListEntryRequest(block: registry_api.v1.CreateStatusListEntryRequestKt.Dsl.() -> kotlin.Unit): registry_api.v1.Registry.CreateStatusListEntryRequest =
  registry_api.v1.CreateStatusListEntryRequestKt.Dsl._create(registry_api.v1.Registry.CreateStatusListEntryRequest.newBuilder()).apply { block() }._build()
/**
 * ```
 * [Example]
 * { 
 ...
 * ```
 *
 * Protobuf type `registry_api.v1.CreateStatusListEntryRequest`
 */
public object CreateStatusListEntryRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: registry_api.v1.Registry.CreateStatusListEntryRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: registry_api.v1.Registry.CreateStatusListEntryRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): registry_api.v1.Registry.CreateStatusListEntryRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun registry_api.v1.Registry.CreateStatusListEntryRequest.copy(block: `registry_api.v1`.CreateStatusListEntryRequestKt.Dsl.() -> kotlin.Unit): registry_api.v1.Registry.CreateStatusListEntryRequest =
  `registry_api.v1`.CreateStatusListEntryRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
