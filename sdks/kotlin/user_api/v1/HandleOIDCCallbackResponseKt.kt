...
@kotlin.jvm.JvmName("-initializehandleOIDCCallbackResponse")
public inline fun handleOIDCCallbackResponse(block: user_api.v1.HandleOIDCCallbackResponseKt.Dsl.() -> kotlin.Unit): user_api.v1.UserOuterClass.HandleOIDCCallbackResponse =
  user_api.v1.HandleOIDCCallbackResponseKt.Dsl._create(user_api.v1.UserOuterClass.HandleOIDCCallbackResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 * [Example] 
 * {
 ...
 * ```
 *
 * Protobuf type `user_api.v1.HandleOIDCCallbackResponse`
 */
public object HandleOIDCCallbackResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: user_api.v1.UserOuterClass.HandleOIDCCallbackResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: user_api.v1.UserOuterClass.HandleOIDCCallbackResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): user_api.v1.UserOuterClass.HandleOIDCCallbackResponse = _builder.build()
    ...
    public val HandleOIDCCallbackResponseKt.Dsl.userOrNull: user_api.v1.UserOuterClass.User?
    ...
    public val HandleOIDCCallbackResponseKt.Dsl.authTokenOrNull: user_api.v1.UserOuterClass.AuthToken?
    ...
    public val HandleOIDCCallbackResponseKt.Dsl.clientStateOrNull: com.google.protobuf.Struct?
      get() = _builder.clientStateOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun user_api.v1.UserOuterClass.HandleOIDCCallbackResponse.copy(block: `user_api.v1`.HandleOIDCCallbackResponseKt.Dsl.() -> kotlin.Unit): user_api.v1.UserOuterClass.HandleOIDCCallbackResponse =
  `user_api.v1`.HandleOIDCCallbackResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val user_api.v1.UserOuterClass.HandleOIDCCallbackResponseOrBuilder.userOrNull: user_api.v1.UserOuterClass.User?
  get() = if (hasUser()) getUser() else null

public val user_api.v1.UserOuterClass.HandleOIDCCallbackResponseOrBuilder.authTokenOrNull: user_api.v1.UserOuterClass.AuthToken?
  get() = if (hasAuthToken()) getAuthToken() else null

public val user_api.v1.UserOuterClass.HandleOIDCCallbackResponseOrBuilder.clientStateOrNull: com.google.protobuf.Struct?
