...
@kotlin.jvm.JvmName("-initializeproposalAckNackData")
public inline fun proposalAckNackData(block: common.ProposalAckNackDataKt.Dsl.() -> kotlin.Unit): common.Amqp.ProposalAckNackData =
  common.ProposalAckNackDataKt.Dsl._create(common.Amqp.ProposalAckNackData.newBuilder()).apply { block() }._build()
/**
 * ```
 *
 * {
 ...
 * ```
 *
 * Protobuf type `common.ProposalAckNackData`
 */
public object ProposalAckNackDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: common.Amqp.ProposalAckNackData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: common.Amqp.ProposalAckNackData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): common.Amqp.ProposalAckNackData = _builder.build()
    ...
    public val ProposalAckNackDataKt.Dsl.contractOrNull: common.PacketOuterClass.Contract?
...
@kotlin.jvm.JvmSynthetic
public inline fun common.Amqp.ProposalAckNackData.copy(block: `common`.ProposalAckNackDataKt.Dsl.() -> kotlin.Unit): common.Amqp.ProposalAckNackData =
  `common`.ProposalAckNackDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val common.Amqp.ProposalAckNackDataOrBuilder.contractOrNull: common.PacketOuterClass.Contract?
