...
@kotlin.jvm.JvmName("-initializecontractProposalCompletedPayload")
public inline fun contractProposalCompletedPayload(block: webhook_api.v1.ContractProposalCompletedPayloadKt.Dsl.() -> kotlin.Unit): webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload =
  webhook_api.v1.ContractProposalCompletedPayloadKt.Dsl._create(webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload.newBuilder()).apply { block() }._build()
/**
 * ```
 * [Example]
 * {
 ...
 * ```
 *
 * Protobuf type `webhook_api.v1.ContractProposalCompletedPayload`
 */
public object ContractProposalCompletedPayloadKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload.copy(block: `webhook_api.v1`.ContractProposalCompletedPayloadKt.Dsl.() -> kotlin.Unit): webhook_api.v1.WebhookOuterClass.ContractProposalCompletedPayload =
  `webhook_api.v1`.ContractProposalCompletedPayloadKt.Dsl._create(this.toBuilder()).apply { block() }._build()
