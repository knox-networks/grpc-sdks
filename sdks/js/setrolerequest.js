...
goog.provide('proto.issuer_api.v1.SetRoleRequest');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.common.Role');
...
proto.issuer_api.v1.SetRoleRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    role: (f = msg.getRole()) && proto.common.Role.toObject(includeInstance, f)
  };
...
proto.issuer_api.v1.SetRoleRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.common.Role;
      reader.readMessage(value,proto.common.Role.deserializeBinaryFromReader);
      msg.setRole(value);
      break;
    default:
      reader.skipField();
...
proto.issuer_api.v1.SetRoleRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.common.Role.serializeBinaryToWriter
    );
  }
};
...
proto.issuer_api.v1.SetRoleRequest.prototype.getRole = function() {
  return /** @type{?proto.common.Role} */ (
    jspb.Message.getWrapperField(this, proto.common.Role, 1));
};
