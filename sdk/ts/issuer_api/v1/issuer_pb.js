...
goog.exportSymbol('proto.issuer_api.v1.AssetDenomination', null, global);
 ...
 * @constructor
 */
proto.issuer_api.v1.AssetDenomination = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.issuer_api.v1.AssetDenomination.repeatedFields_, null);
};
goog.inherits(proto.issuer_api.v1.AssetDenomination, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.issuer_api.v1.AssetDenomination.displayName = 'proto.issuer_api.v1.AssetDenomination';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.issuer_api.v1.AssetDenomination.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.issuer_api.v1.AssetDenomination.prototype.toObject = function(opt_includeInstance) {
  return proto.issuer_api.v1.AssetDenomination.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.issuer_api.v1.AssetDenomination} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.issuer_api.v1.AssetDenomination.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.issuer_api.v1.AssetDenomination}
 */
proto.issuer_api.v1.AssetDenomination.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.issuer_api.v1.AssetDenomination;
  return proto.issuer_api.v1.AssetDenomination.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.issuer_api.v1.AssetDenomination} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.issuer_api.v1.AssetDenomination}
 */
proto.issuer_api.v1.AssetDenomination.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.issuer_api.v1.AssetDenomination.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.issuer_api.v1.AssetDenomination.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.issuer_api.v1.AssetDenomination} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.issuer_api.v1.AssetDenomination.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<number>}
 */
proto.issuer_api.v1.AssetDenomination.prototype.getDenominationsList = function() {
 ...
 * @return {!proto.issuer_api.v1.AssetDenomination} returns this
 */
proto.issuer_api.v1.AssetDenomination.prototype.setDenominationsList = function(value) {
 ...
 * @return {!proto.issuer_api.v1.AssetDenomination} returns this
 */
proto.issuer_api.v1.AssetDenomination.prototype.addDenominations = function(value, opt_index) {
 ...
 * @return {!proto.issuer_api.v1.AssetDenomination} returns this
 */
proto.issuer_api.v1.AssetDenomination.prototype.clearDenominationsList = function() {
 ...
 * @return {number}
 */
proto.issuer_api.v1.AssetDenomination.prototype.getPrecision = function() {
 ...
 * @return {!proto.issuer_api.v1.AssetDenomination} returns this
 */
proto.issuer_api.v1.AssetDenomination.prototype.setPrecision = function(value) {
...
proto.issuer_api.v1.SetAssetDenominationsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    denominationsMap: (f = msg.getDenominationsMap()) ? f.toObject(includeInstance, proto.issuer_api.v1.AssetDenomination.toObject) : []
  };
...
proto.issuer_api.v1.SetAssetDenominationsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.issuer_api.v1.AssetDenomination.deserializeBinaryFromReader, "", new proto.issuer_api.v1.AssetDenomination());
         });
      break;
    default:
      reader.skipField();
...
proto.issuer_api.v1.SetAssetDenominationsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.issuer_api.v1.AssetDenomination.serializeBinaryToWriter);
  }
};


/**
 * map<string, AssetDenomination> denominations = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.issuer_api.v1.AssetDenomination>}
 */
proto.issuer_api.v1.SetAssetDenominationsRequest.prototype.getDenominationsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.issuer_api.v1.AssetDenomination>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.issuer_api.v1.AssetDenomination));
};
