...
goog.exportSymbol('proto.common.AssetAuthority', null, global);
goog.exportSymbol('proto.common.AssetDenomination', null, global);
...
goog.exportSymbol('proto.common.Filter', null, global);
goog.exportSymbol('proto.common.FilterItem', null, global);
goog.exportSymbol('proto.common.FilterItem.FilterOperator', null, global);
goog.exportSymbol('proto.common.FilterItem.ValueCase', null, global);
...
goog.exportSymbol('proto.common.LogicalOperator', null, global);
...
goog.exportSymbol('proto.common.SortItem', null, global);
 ...
 * @constructor
 */
proto.common.SortItem = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.common.SortItem, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.SortItem.displayName = 'proto.common.SortItem';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.common.AuthenticationRequest.prototype.getConnectionId = function() {
 ...
 * @return {!proto.common.AuthenticationRequest} returns this
 */
proto.common.AuthenticationRequest.prototype.setConnectionId = function(value) {
 ...
 * @return {!Object}
 */
proto.common.SortItem.prototype.toObject = function(opt_includeInstance) {
  return proto.common.SortItem.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.SortItem} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.SortItem.toObject = function(includeInstance, msg) {
  var f, obj = {
    field: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 */
proto.common.SortItem.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.SortItem;
  return proto.common.SortItem.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.SortItem} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.SortItem}
 */
proto.common.SortItem.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.common.SortItem.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.SortItem.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.SortItem} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.SortItem.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getField();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.common.SortItem.prototype.getField = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.common.SortItem} returns this
 */
proto.common.SortItem.prototype.setField = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.common.SortItem.prototype.getDirection = function() {
  return /** @type {!proto.common.SortDirection} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.common.SortItem} returns this
 */
proto.common.SortItem.prototype.setDirection = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
