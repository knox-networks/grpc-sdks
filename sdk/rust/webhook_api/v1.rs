...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum PrevalidationTriggerType {
    /// Prevalidation Trigger Unspecified.
    PrevalidationTriggerUnspecified = 0,
    /// Prevalidation Trigger Considering Contract.
    PrevalidationTriggerConsideringContract = 1,
}
impl PrevalidationTriggerType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PrevalidationTriggerType::PrevalidationTriggerUnspecified => "PREVALIDATION_TRIGGER_UNSPECIFIED",
            PrevalidationTriggerType::PrevalidationTriggerConsideringContract => "PREVALIDATION_TRIGGER_CONSIDERING_CONTRACT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "PREVALIDATION_TRIGGER_UNSPECIFIED" => Some(Self::PrevalidationTriggerUnspecified),
            "PREVALIDATION_TRIGGER_CONSIDERING_CONTRACT" => Some(Self::PrevalidationTriggerConsideringContract),
            _ => None,
        }
    }
}
