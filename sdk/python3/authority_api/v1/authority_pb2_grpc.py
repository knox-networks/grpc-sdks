...
class AuthorityStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmissary = channel.unary_unary('/authority_api.v1.Authority/GetEmissary', request_serializer=authority__api_dot_v1_dot_authority__pb2.GetEmissaryRequest.SerializeToString, response_deserializer=authority__api_dot_v1_dot_authority__pb2.GetEmissaryResponse.FromString)
        self.GetNotary = channel.unary_unary('/authority_api.v1.Authority/GetNotary', request_serializer=authority__api_dot_v1_dot_authority__pb2.GetNotaryRequest.SerializeToString, response_deserializer=authority__api_dot_v1_dot_authority__pb2.GetNotaryResponse.FromString)
...
class AuthorityServicer(object):
    ...
    def GetEmissary(self, request, context):
...
class Authority(object):
    ...
    @staticmethod
    def GetEmissary(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/authority_api.v1.Authority/GetEmissary', authority__api_dot_v1_dot_authority__pb2.GetEmissaryRequest.SerializeToString, authority__api_dot_v1_dot_authority__pb2.GetEmissaryResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
