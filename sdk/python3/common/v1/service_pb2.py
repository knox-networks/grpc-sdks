...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TRANSACTIONSERVICE._serialized_start = 60
    _TRANSACTIONSERVICE._serialized_end = 256
    _SERVICEINFO._serialized_start = 259
    _SERVICEINFO._serialized_end = 425