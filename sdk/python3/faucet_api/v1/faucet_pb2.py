...
_MONETAEFAUCETSERVICE = DESCRIPTOR.services_by_name['MonetaeFaucetService']
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MONETAEFAUCETSERVICE._serialized_start = 252
    _MONETAEFAUCETSERVICE._serialized_end = 345