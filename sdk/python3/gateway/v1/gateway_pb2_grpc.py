...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Authenticate = channel.unary_unary('/gateway.Gateway/Authenticate', request_serializer=common_dot_v1_dot_common__pb2.AuthenticationRequest.SerializeToString, response_deserializer=common_dot_v1_dot_common__pb2.AuthenticationResponse.FromString)
        self.Data = channel.stream_stream('/gateway.Gateway/Data', request_serializer=common_dot_v1_dot_packet__pb2.Packet.SerializeToString, response_deserializer=common_dot_v1_dot_packet__pb2.Packet.FromString)
...
def add_GatewayServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('gateway.Gateway', rpc_method_handlers)
...
class Gateway(object):
    ...
    def Authenticate(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gateway.Gateway/Authenticate', common_dot_v1_dot_common__pb2.AuthenticationRequest.SerializeToString, common_dot_v1_dot_common__pb2.AuthenticationResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Data(request_iterator, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/gateway.Gateway/Data', common_dot_v1_dot_packet__pb2.Packet.SerializeToString, common_dot_v1_dot_packet__pb2.Packet.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetConnections(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gateway.Gateway/GetConnections', gateway_dot_v1_dot_gateway__pb2.ConnectionsRequest.SerializeToString, gateway_dot_v1_dot_gateway__pb2.ConnectionsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)