...
class CredentialAdapterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateVerifiableCredentialStatus = channel.unary_unary('/vc_api.v1.CredentialAdapterService/UpdateVerifiableCredentialStatus', request_serializer=vc__api_dot_v1_dot_vc__pb2.UpdateVerifiableCredentialStatusRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.UpdateVerifiableCredentialStatusResponse.FromString)
...
class CredentialAdapterServiceServicer(object):
    ...
    def UpdateVerifiableCredentialStatus(self, request, context):
...
class CredentialAdapterService(object):
    ...
    @staticmethod
    def UpdateVerifiableCredentialStatus(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/vc_api.v1.CredentialAdapterService/UpdateVerifiableCredentialStatus', vc__api_dot_v1_dot_vc__pb2.UpdateVerifiableCredentialStatusRequest.SerializeToString, vc__api_dot_v1_dot_vc__pb2.UpdateVerifiableCredentialStatusResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)