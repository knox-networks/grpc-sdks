...
class CredentialAdapterStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CreateIssuanceChallenge = channel.unary_unary('/vc_api.v1.CredentialAdapter/CreateIssuanceChallenge', request_serializer=vc__api_dot_v1_dot_vc__pb2.CreateIssuanceChallengeRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.CreateIssuanceChallengeResponse.FromString)
        self.IssueVerifiableCredential = channel.unary_unary('/vc_api.v1.CredentialAdapter/IssueVerifiableCredential', request_serializer=vc__api_dot_v1_dot_vc__pb2.IssueVerifiableCredentialRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.IssueVerifiableCredentialResponse.FromString)
        self.CreatePresentationChallenge = channel.unary_unary('/vc_api.v1.CredentialAdapter/CreatePresentationChallenge', request_serializer=vc__api_dot_v1_dot_vc__pb2.CreatePresentationChallengeRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.CreatePresentationChallengeResponse.FromString)
        self.PresentVerifiableCredential = channel.unary_unary('/vc_api.v1.CredentialAdapter/PresentVerifiableCredential', request_serializer=vc__api_dot_v1_dot_vc__pb2.PresentVerifiableCredentialRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.PresentVerifiableCredentialResponse.FromString)
        self.WaitForCompletion = channel.unary_stream('/vc_api.v1.CredentialAdapter/WaitForCompletion', request_serializer=vc__api_dot_v1_dot_vc__pb2.WaitForCompletionRequest.SerializeToString, response_deserializer=vc__api_dot_v1_dot_vc__pb2.WaitForCompletionResponse.FromString)

class CredentialAdapterServicer(object):
    """Enables existing systems to support W3C Verifiable Credential (VC) interactions between holders, VC issuers and verifiers as per https://www.w3.org/TR/vc-data-model/.  It is either used by credential providers (VC Issuer) or verifiers as required.  It provides predefined interfaces to expose (Example Bank customer info APIs) but allows for custom integrations as required.
    """
...
def add_CredentialAdapterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('vc_api.v1.CredentialAdapter', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))

class CredentialAdapter(object):
    """Enables existing systems to support W3C Verifiable Credential (VC) interactions between holders, VC issuers and verifiers as per https://www.w3.org/TR/vc-data-model/.  It is either used by credential providers (VC Issuer) or verifiers as required.  It provides predefined interfaces to expose (Example Bank customer info APIs) but allows for custom integrations as required.
    """
    ...
    def CreatePresentationChallenge(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/vc_api.v1.CredentialAdapter/CreatePresentationChallenge', vc__api_dot_v1_dot_vc__pb2.CreatePresentationChallengeRequest.SerializeToString, vc__api_dot_v1_dot_vc__pb2.CreatePresentationChallengeResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def WaitForCompletion(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_stream(request, target, '/vc_api.v1.CredentialAdapter/WaitForCompletion', vc__api_dot_v1_dot_vc__pb2.WaitForCompletionRequest.SerializeToString, vc__api_dot_v1_dot_vc__pb2.WaitForCompletionResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)