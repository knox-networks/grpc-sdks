...
class IssuerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetAssetDenominations = channel.unary_unary('/issuer_api.v1.IssuerService/SetAssetDenominations', request_serializer=issuer__api_dot_v1_dot_issuer__pb2.SetAssetDenominationsRequest.SerializeToString, response_deserializer=issuer__api_dot_v1_dot_issuer__pb2.SetAssetDenominationsResponse.FromString)
        self.SetAssetAuthorities = channel.unary_unary('/issuer_api.v1.IssuerService/SetAssetAuthorities', request_serializer=issuer__api_dot_v1_dot_issuer__pb2.SetAssetAuthoritiesRequest.SerializeToString, response_deserializer=issuer__api_dot_v1_dot_issuer__pb2.SetAssetAuthoritiesResponse.FromString)
...
class IssuerServiceServicer(object):
    ...
    def SetAssetDenominations(self, request, context):
...
class IssuerService(object):
    ...
    @staticmethod
    def SetAssetDenominations(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/issuer_api.v1.IssuerService/SetAssetDenominations', issuer__api_dot_v1_dot_issuer__pb2.SetAssetDenominationsRequest.SerializeToString, issuer__api_dot_v1_dot_issuer__pb2.SetAssetDenominationsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetAssetAuthorities(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/issuer_api.v1.IssuerService/SetAssetAuthorities', issuer__api_dot_v1_dot_issuer__pb2.SetAssetAuthoritiesRequest.SerializeToString, issuer__api_dot_v1_dot_issuer__pb2.SetAssetAuthoritiesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)