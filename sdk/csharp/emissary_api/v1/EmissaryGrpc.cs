...
namespace Emissary {
  public static partial class Emissary
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Method<global::Common.Packet, global::Common.Packet> __Method_Connection = new grpc::Method<global::Common.Packet, global::Common.Packet>(
    ...
    public abstract partial class EmissaryBase
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task Connection(grpc::IAsyncStreamReader<global::Common.Packet> requestStream, grpc::IServerStreamWriter<global::Common.Packet> responseStream, grpc::ServerCallContext context)
      {
    ...
    public partial class EmissaryClient : grpc::ClientBase<EmissaryClient>
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncDuplexStreamingCall<global::Common.Packet, global::Common.Packet> Connection(grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return Connection(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      /// <summary>
      /// Establish an emissary connection to the gateway.
      /// </summary>
      ...
      /// <returns>The call object.</returns>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncDuplexStreamingCall<global::Common.Packet, global::Common.Packet> Connection(grpc::CallOptions options)
      {
        return CallInvoker.AsyncDuplexStreamingCall(__Method_Connection, null, options);
      }
    ...
    public static grpc::ServerServiceDefinition BindService(EmissaryBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_Connection, serviceImpl.Connection).Build();
    }
    ...
    {
      serviceBinder.AddMethod(__Method_Connection, serviceImpl == null ? null : new grpc::DuplexStreamingServerMethod<global::Common.Packet, global::Common.Packet>(serviceImpl.Connection));
    }
