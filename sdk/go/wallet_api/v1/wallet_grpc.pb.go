...
type WalletServiceClient interface {
	...
	ListContractTransactions(ctx context.Context, in *ListContractTransactionsRequest, opts ...grpc.CallOption) (*ListContractTransactionsResponse, error)
	// Get detailed information about a contract transaction.
	GetContractTransactionDetail(ctx context.Context, in *GetContractTransactionDetailRequest, opts ...grpc.CallOption) (*GetContractTransactionDetailResponse, error)
	// Create a new contract transaction
	PrepareContractTransaction(ctx context.Context, in *PrepareContractTransactionRequest, opts ...grpc.CallOption) (*PrepareContractTransactionResponse, error)
...
func (c *walletServiceClient) ListContractTransactions(ctx context.Context, in *ListContractTransactionsRequest, opts ...grpc.CallOption) (*ListContractTransactionsResponse, error) {
	out := new(ListContractTransactionsResponse)
	err := c.cc.Invoke(ctx, "/wallet_api.v1.WalletService/ListContractTransactions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletServiceClient) GetContractTransactionDetail(ctx context.Context, in *GetContractTransactionDetailRequest, opts ...grpc.CallOption) (*GetContractTransactionDetailResponse, error) {
	out := new(GetContractTransactionDetailResponse)
	err := c.cc.Invoke(ctx, "/wallet_api.v1.WalletService/GetContractTransactionDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletServiceClient) PrepareContractTransaction(ctx context.Context, in *PrepareContractTransactionRequest, opts ...grpc.CallOption) (*PrepareContractTransactionResponse, error) {
	out := new(PrepareContractTransactionResponse)
	err := c.cc.Invoke(ctx, "/wallet_api.v1.WalletService/PrepareContractTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletServiceServer interface {
	...
	// List contract transactions
	ListContractTransactions(context.Context, *ListContractTransactionsRequest) (*ListContractTransactionsResponse, error)
	// Get detailed information about a contract transaction.
	GetContractTransactionDetail(context.Context, *GetContractTransactionDetailRequest) (*GetContractTransactionDetailResponse, error)
	// Create a new contract transaction
	PrepareContractTransaction(context.Context, *PrepareContractTransactionRequest) (*PrepareContractTransactionResponse, error)
	// Attempts to start an atomic asset swap. The call immediately returns with a `status` and `uetr` that can
	// be used to query more information about the transaction.
...
func (UnimplementedWalletServiceServer) ListContractTransactions(context.Context, *ListContractTransactionsRequest) (*ListContractTransactionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListContractTransactions not implemented")
}
func (UnimplementedWalletServiceServer) GetContractTransactionDetail(context.Context, *GetContractTransactionDetailRequest) (*GetContractTransactionDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetContractTransactionDetail not implemented")
}
func (UnimplementedWalletServiceServer) PrepareContractTransaction(context.Context, *PrepareContractTransactionRequest) (*PrepareContractTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrepareContractTransaction not implemented")
}
...
func _WalletService_ListContractTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListContractTransactionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServiceServer).ListContractTransactions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wallet_api.v1.WalletService/ListContractTransactions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).ListContractTransactions(ctx, req.(*ListContractTransactionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _WalletService_GetContractTransactionDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetContractTransactionDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServiceServer).GetContractTransactionDetail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wallet_api.v1.WalletService/GetContractTransactionDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).GetContractTransactionDetail(ctx, req.(*GetContractTransactionDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _WalletService_PrepareContractTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PrepareContractTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServiceServer).PrepareContractTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wallet_api.v1.WalletService/PrepareContractTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).PrepareContractTransaction(ctx, req.(*PrepareContractTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WalletService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WalletService_ListContractTransactions_Handler,
		},
		{
			MethodName: "GetContractTransactionDetail",
			Handler:    _WalletService_GetContractTransactionDetail_Handler,
		},
		{
			MethodName: "PrepareContractTransaction",
			Handler:    _WalletService_PrepareContractTransaction_Handler,
		},
		{
