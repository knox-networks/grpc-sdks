...
type UpdateVerifiableCredentialStatusType int32

const (
	// Update Type to VC Status is Unspecified.
	UpdateVerifiableCredentialStatusType_UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_UNSPECIFIED UpdateVerifiableCredentialStatusType = 0
	// Update Type to VC Status is Revocation.
	UpdateVerifiableCredentialStatusType_UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_REVOCATION UpdateVerifiableCredentialStatusType = 1
	// Update Type to VC Status is Suspension.
	UpdateVerifiableCredentialStatusType_UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_SUSPENSION UpdateVerifiableCredentialStatusType = 2
)

// Enum value maps for UpdateVerifiableCredentialStatusType.
var (
	UpdateVerifiableCredentialStatusType_name = map[int32]string{
		0: "UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_UNSPECIFIED",
		1: "UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_REVOCATION",
		2: "UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_SUSPENSION",
	}
	UpdateVerifiableCredentialStatusType_value = map[string]int32{
...
func (x UpdateVerifiableCredentialStatusType) Enum() *UpdateVerifiableCredentialStatusType {
	p := new(UpdateVerifiableCredentialStatusType)
	*p = x
	return p
}

func (x UpdateVerifiableCredentialStatusType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UpdateVerifiableCredentialStatusType) Descriptor() protoreflect.EnumDescriptor {
	return file_vc_api_v1_vc_proto_enumTypes[1].Descriptor()
}

func (UpdateVerifiableCredentialStatusType) Type() protoreflect.EnumType {
	return &file_vc_api_v1_vc_proto_enumTypes[1]
}

func (x UpdateVerifiableCredentialStatusType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UpdateVerifiableCredentialStatusType.Descriptor instead.
func (UpdateVerifiableCredentialStatusType) EnumDescriptor() ([]byte, []int) {
...
// "update_type": 1
// }
type UpdateVerifiableCredentialStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	UpdateType UpdateVerifiableCredentialStatusType `protobuf:"varint,3,opt,name=update_type,json=updateType,proto3,enum=vc_api.v1.UpdateVerifiableCredentialStatusType" json:"update_type,omitempty"`
}

func (x *UpdateVerifiableCredentialStatusRequest) Reset() {
	*x = UpdateVerifiableCredentialStatusRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vc_api_v1_vc_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateVerifiableCredentialStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateVerifiableCredentialStatusRequest) ProtoMessage() {}

func (x *UpdateVerifiableCredentialStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_vc_api_v1_vc_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateVerifiableCredentialStatusRequest.ProtoReflect.Descriptor instead.
func (*UpdateVerifiableCredentialStatusRequest) Descriptor() ([]byte, []int) {
	return file_vc_api_v1_vc_proto_rawDescGZIP(), []int{11}
}

func (x *UpdateVerifiableCredentialStatusRequest) GetCredentialType() CredentialType {
	if x != nil {
		return x.CredentialType
	}
	return CredentialType_CREDENTIAL_TYPE_UNSPECIFIED
...
func (x *UpdateVerifiableCredentialStatusRequest) GetDid() string {
	if x != nil {
		return x.Did
	}
	return ""
...
func (x *UpdateVerifiableCredentialStatusRequest) GetUpdateType() UpdateVerifiableCredentialStatusType {
	if x != nil {
		return x.UpdateType
	}
	return UpdateVerifiableCredentialStatusType_UPDATE_VERIFIABLE_CREDENTIAL_STATUS_TYPE_UNSPECIFIED
}

// [Example]
// {}
type UpdateVerifiableCredentialStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UpdateVerifiableCredentialStatusResponse) Reset() {
	*x = UpdateVerifiableCredentialStatusResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vc_api_v1_vc_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateVerifiableCredentialStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateVerifiableCredentialStatusResponse) ProtoMessage() {}

func (x *UpdateVerifiableCredentialStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_vc_api_v1_vc_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateVerifiableCredentialStatusResponse.ProtoReflect.Descriptor instead.
func (*UpdateVerifiableCredentialStatusResponse) Descriptor() ([]byte, []int) {
	return file_vc_api_v1_vc_proto_rawDescGZIP(), []int{12}
}
...
var file_vc_api_v1_vc_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x76, 0x63, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x1a,
	0x1c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x6e, 0x6e, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb6, 0x01,
	0x0a, 0x0f, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x50, 0x72, 0x6f, 0x6f,
	...
	0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x76, 0x65,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x64, 0x22, 0x43, 0x0a, 0x21, 0x49, 0x73, 0x73, 0x75, 0x65,
	...
	0x52, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x6a, 0x0a, 0x22,
	...
	0x73, 0x74, 0x12, 0x44, 0x0a, 0x10, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x76,
	0x63, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x23, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	...
	0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69,
	0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69,
	0x6e, 0x74, 0x12, 0x44, 0x0a, 0x10, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x76,
	0x63, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0xd2, 0x01, 0x0a, 0x22, 0x50, 0x72, 0x65,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x4f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x49, 0x22, 0x44, 0x2f, 0x76, 0x63, 0x5f, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	0x41, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x43,
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a,
...
var file_vc_api_v1_vc_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_vc_api_v1_vc_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_vc_api_v1_vc_proto_goTypes = []interface{}{
	(CredentialType)(0),                              // 0: vc_api.v1.CredentialType
	(UpdateVerifiableCredentialStatusType)(0),        // 1: vc_api.v1.UpdateVerifiableCredentialStatusType
	(*CredentialProof)(nil),                          // 2: vc_api.v1.CredentialProof
	(*CreateIssuanceChallengeRequest)(nil),           // 3: vc_api.v1.CreateIssuanceChallengeRequest
	(*CreateIssuanceChallengeResponse)(nil),          // 4: vc_api.v1.CreateIssuanceChallengeResponse
	(*IssueVerifiableCredentialRequest)(nil),         // 5: vc_api.v1.IssueVerifiableCredentialRequest
	(*IssueVerifiableCredentialResponse)(nil),        // 6: vc_api.v1.IssueVerifiableCredentialResponse
	(*CreatePresentationChallengeRequest)(nil),       // 7: vc_api.v1.CreatePresentationChallengeRequest
	(*CreatePresentationChallengeResponse)(nil),      // 8: vc_api.v1.CreatePresentationChallengeResponse
	(*PresentVerifiableCredentialRequest)(nil),       // 9: vc_api.v1.PresentVerifiableCredentialRequest
	(*PresentVerifiableCredentialResponse)(nil),      // 10: vc_api.v1.PresentVerifiableCredentialResponse
	(*WaitForCompletionRequest)(nil),                 // 11: vc_api.v1.WaitForCompletionRequest
	(*WaitForCompletionResponse)(nil),                // 12: vc_api.v1.WaitForCompletionResponse
	(*UpdateVerifiableCredentialStatusRequest)(nil),  // 13: vc_api.v1.UpdateVerifiableCredentialStatusRequest
	(*UpdateVerifiableCredentialStatusResponse)(nil), // 14: vc_api.v1.UpdateVerifiableCredentialStatusResponse
}
var file_vc_api_v1_vc_proto_depIdxs = []int32{
	...
	0,  // 6: vc_api.v1.UpdateVerifiableCredentialStatusRequest.credential_type:type_name -> vc_api.v1.CredentialType
	1,  // 7: vc_api.v1.UpdateVerifiableCredentialStatusRequest.update_type:type_name -> vc_api.v1.UpdateVerifiableCredentialStatusType
	3,  // 8: vc_api.v1.CredentialAdapterService.CreateIssuanceChallenge:input_type -> vc_api.v1.CreateIssuanceChallengeRequest
	5,  // 9: vc_api.v1.CredentialAdapterService.IssueVerifiableCredential:input_type -> vc_api.v1.IssueVerifiableCredentialRequest
	7,  // 10: vc_api.v1.CredentialAdapterService.CreatePresentationChallenge:input_type -> vc_api.v1.CreatePresentationChallengeRequest
	9,  // 11: vc_api.v1.CredentialAdapterService.PresentVerifiableCredential:input_type -> vc_api.v1.PresentVerifiableCredentialRequest
	11, // 12: vc_api.v1.CredentialAdapterService.WaitForCompletion:input_type -> vc_api.v1.WaitForCompletionRequest
	13, // 13: vc_api.v1.CredentialAdapterService.UpdateVerifiableCredentialStatus:input_type -> vc_api.v1.UpdateVerifiableCredentialStatusRequest
	4,  // 14: vc_api.v1.CredentialAdapterService.CreateIssuanceChallenge:output_type -> vc_api.v1.CreateIssuanceChallengeResponse
	6,  // 15: vc_api.v1.CredentialAdapterService.IssueVerifiableCredential:output_type -> vc_api.v1.IssueVerifiableCredentialResponse
	8,  // 16: vc_api.v1.CredentialAdapterService.CreatePresentationChallenge:output_type -> vc_api.v1.CreatePresentationChallengeResponse
	10, // 17: vc_api.v1.CredentialAdapterService.PresentVerifiableCredential:output_type -> vc_api.v1.PresentVerifiableCredentialResponse
	12, // 18: vc_api.v1.CredentialAdapterService.WaitForCompletion:output_type -> vc_api.v1.WaitForCompletionResponse
	14, // 19: vc_api.v1.CredentialAdapterService.UpdateVerifiableCredentialStatus:output_type -> vc_api.v1.UpdateVerifiableCredentialStatusResponse
...
func file_vc_api_v1_vc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vc_api_v1_vc_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateVerifiableCredentialStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vc_api_v1_vc_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateVerifiableCredentialStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
